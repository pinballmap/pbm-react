...
- Fixed a bug where a couple buttons were requiring two presses before they registered the press.
...
- Fix a bug where app crashes after pressing some buttons.
- Fix a potential drawer menu bug.

### 5.4.15

July 28, 2026

- Fixed a bug where locations without a zip code was displaying null for the zip.
...
- Add standalone "add high score" form that isn't associated with a location-specific machine.
- Add pinch to zoom functionality for location photos.
- Some bug fixes.
...
- Added a "life list" feature so you can track all the machines you've played if you want.
...
- Fix issue with machine selection list (and other lists) displaying weird as you type or backspace to filter list.
