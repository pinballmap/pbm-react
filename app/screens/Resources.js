    ...
    return (
        <SafeAreaView edges={['right', 'bottom', 'left']} style={{ flex: 1 }}>
            <Screen>
                ...
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://matchplay.events')} style={[s.logoWrapper, { backgroundColor: '#f5f5ff', paddingVertical: 10, }]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://matchplay.events/')}>{`Match Play Events`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://pindigo.app')} style={[s.logoWrapper, { backgroundColor: '#363377', paddingVertical: 10, }]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://pindigo.app')}>{`Pindigo`}</Text>
                    {` is an app for recording your scores. You can track all your high scores and compare them with friends.`}
                </Text>
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://www.pinballnews.com/site/')} style={[s.logoWrapper]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://www.pinballnews.com/site/')}>{`Pinball News`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://www.ifpapinball.com')} style={[s.logoWrapper]}>
                ...
                <Text style={s.text}>
                    {`The `}<Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://www.ifpapinball.com')}>{`IFPA`}</Text>
                ...
                <View style={s.hr}></View>
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://opdb.org/')}>{`OPDB`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://pintips.net')} style={[s.logoWrapper]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://pintips.net')}>{`PinTips`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://pinside.com/')} style={[s.logoWrapper, { backgroundColor: '#ff953e', paddingVertical: 10 }]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://pinside.com/')}>{`Pinside`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://scorbit.io/')} style={[s.logoWrapper]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://scorbit.io/')}>{`Scorbit`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://www.youtube.com/channel/UCp-cSoq5qVVyts7H8rQjV-w')} style={[s.logoWrapper]}>
                    <Image source={require('../assets/images/Resource_PAPA.jpg')} style={{ width: deviceWidth - 70, height: deviceWidth - 70, resizeMode: 'stretch' }} />
                </Pressable>
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://www.youtube.com/channel/UCp-cSoq5qVVyts7H8rQjV-w')}>{`PAPA Pinball`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://discord.com/invite/XffPx6VKTv')} style={[s.logoWrapper]}>
                ...
                <Text style={s.text}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://discord.com/invite/XffPx6VKTv')}>{`Pinball People`}</Text>
                ...
                <View style={s.hr}></View>
                <Pressable onPress={() => WebBrowser.openBrowserAsync('https://www.deadflip.com/')} style={[s.logoWrapper]}>
                ...
                <Text style={[s.text, { marginBottom: 20 }]}>
                    <Text style={s.textLink} onPress={() => WebBrowser.openBrowserAsync('https://www.deadflip.com/')}>{`Dead Flip`}</Text>
