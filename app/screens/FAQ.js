            ...
            <Screen>
                <View style={s.container}>
                    <View style={s.child}>
                        ...
                        <Text style={s.text}>{`Great question! As a small token of acknowledgement of your contributions to the map, if you make more than 50 contributions, we christen you a "Super Contributor". After 250 contributions, you are a "Legendary Contributor". And after 500 amazing map contributions, you are a "Grand Champ Contributor"!`}</Text>
                        ...
                        <Text style={s.text}>{`Maybe! We can try. Pinball Map is an open source app. You can submit "issues" to `} <Text style={{textDecorationLine: 'underline'}} onPress={() => Linking.openURL('https://github.com/bpoore/pbm-react')}>{`the Github repository`}</Text>{`, and you can also directly contribute code.`}</Text>
...
FAQ.navigationOptions = ({ navigation, theme }) => ({
    drawerLabel: 'FAQ',
    drawerIcon: () => <MaterialIcons name='question-answer' style={{fontSize: 24, color: '#bec2e6'}} />,
