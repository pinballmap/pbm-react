      ...
      >
        <View style={s.container}>
          <View style={s.child}>
            ...
            <View style={s.toc}>
              <Text style={s.text}>Jump to:</Text>
            ...
            <View style={s.answer}>
              ...
              <View style={[s.iconView, { paddingBottom: 8 }]}>
                <Image
            ...
            <View style={s.answer}>
              ...
              <Text style={s.text}>
                ...
                : Take photo straight on, not at an angle. Crop image to show
                only artwork. Avoid glare, if possible.
              </Text>
            </View>
            <View
              ref={(r) => {
            ...
            <View style={s.answer}>
              ...
              <Text style={s.text}>
                {`If your app displays data for a specific location, the attribution link must point to that location's listing, not just the homepage: https://pinballmap.com/map?by_location_id={location_id}. Given Pinball Map's role as a source of truth for many, it's important to explicitly direct people to the site so that they can update it. If possible, we encourage your link to include some kind of explanatory language, like "update this location listing at Pinball Map."`}
              </Text>
              <Text style={s.text}>
              ...
              <Text style={s.text}>
                {`If you have questions, get in touch. We have collaborated with many folks on their projects, from student projects to services by major pinball companies. We are happy to give recommendations for optimal use (remember that our server resources are not infinite).`}
              </Text>
            </View>
            <View
              ref={(r) => {
            ...
            <View style={s.answer}>
              <Text style={s.text}>
                ...
                <Text
                  style={s.textLink}
                  onPress={() =>
                    WebBrowser.openBrowserAsync("https://opdb.org")
                  }
                >
                  OPDB
                </Text>{" "}
            ...
            <View style={s.answer}>
              ...
              <Text style={[s.text]}>
                ...
                {` about the benefits of being listed in our system, and the tools available. Once you tag all of your locations, you'll be able to quickly see all your locations using the "Filter".`}
              </Text>
            </View>
            <View style={s.question}>
              <Text
            ...
            <View style={s.answer}>
              ...
              <Text
                style={s.text}
              >{`\u2022 If you have a website, give us the link and your business name will appear as a hyperlink.`}</Text>
              <Text
                style={s.text}
              >{`\u2022 If you want users to be able to directly text/call you (if so, include your number).`}</Text>
              <Text
                style={s.text}
              >{`\u2022 If you want users to be able to directly email you.`}</Text>
            </View>
            <View style={s.question}>
              <Text
                style={s.bold}
            ...
            <View style={s.answer}>
              ...
              <Text
                style={s.text}
              >{`You can do the same for scores, too.`}</Text>
            </View>
            <View style={s.question}>
              <Text
                style={s.bold}
