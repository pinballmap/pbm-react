...
const NoLocationTrackingModal = ({ showNoLocationTrackingModal, hideNoLocationTrackingModal }) => (
    <ConfirmationModal
...
export default connect(mapStateToProps, mapDispatchToProps)(NoLocationTrackingModal)
