...
const PbmButton = ({ title, accessibilityLabel, buttonStyle, containerStyle, titleStyle, onPress, icon, iconPosition, disabled }) => {
    ...
    return (
        <Button
            ...
            containerStyle={[{ overflow: 'visible', borderRadius: 25, backgroundColor: theme.base1, shadowColor: theme.shadow, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.6, shadowRadius: 6, elevation: 6, }, containerStyle ? containerStyle : styles.margin15]}
        />
    )
}
