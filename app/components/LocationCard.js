    ...
    return(
        <Card style={{flex: 1}}>
          <View style={s.flexi}>
            ...
            <Ionicons style={s.iconStyle} name="ios-arrow-dropright" onPress={() => this.props.navigation.navigate('LocationDetails', {id: this.props.id, locationName: this.props.name})}/>
          </View>
        </Card>
    );
  }
